...
const Menu = [
  {
    ...
    rating: "6.9",
    context:
      "After a public spat with a movie star, a disgraced director retaliates by kidnapping the actor's daughter and films the search for her in real time.",
  ...
  },
  {
    ...
    rating: "6.7",
    context:
      "Fashion designer Masaba Gupta straddles the worlds of fashion and family while making a foray back into the dating world.",
  ...
  },
  {
    ...
    rating: "6.0",
    context:
      "A former soldier teams up with a cop to find the source behind a dangerous pill that provides temporary, unpredictable superpowers.",
  ...
  },
  {
    ...
    rating: "6.7",
    context:
      "Time-travelling fighter pilot Adam Reed teams up with his 12-year-old self for a mission to save the future after unintentionally crash landing in 2022.",
  ...
  },
  {
    ...
    rating: "6.9",
    context:
      "Peter Parker, an outcast high school student, gets bitten by a radioactive spider and attains superpowers. Soon, he is forced to use his abilities to fight a monstrous foe. teams up with his 12-year-old self for a mission to save the future after unintentionally crash landing in 2022.",
